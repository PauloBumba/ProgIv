...
{
    public class Repository : IMedicationRepository
    {
        private readonly UserCaseDbContext _context;

        public Repository(UserCaseDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IEnumerable<MedicationSchedule>> GetSchedulesByMedicationIdAsync(Guid medId)
        {
        ...
        public async Task<MedicationSchedule?> GetScheduleByIdAsync(Guid scheduleId)
        {
            return await _context.MedicationSchedules
                                 .AsNoTracking()
        ...
        public async Task<IEnumerable<MedicationHistory>> GetHistoriesByMedicationIdAsync(Guid medId)
        {
        ...
        // GetHistoryById
        public async Task<MedicationHistory?> GetMedicationHistoryByIdAsync(Guid historyId)
        {
            return await _context.MedicationHistories
                                 .AsNoTracking()
